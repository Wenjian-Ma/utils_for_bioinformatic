...
# precision, recall, thresholds = precision_recall_curve(label_Test_60, score_Test_60)
...
# precision_Test_60, recall_Test_60, thresholds = precision_recall_curve(label_Test_60, score_Test_60)
...
plt.plot(fpr_Test_60, tpr_Test_60, lw=line_width, label='Test_60 (AUROC = %0.3f)' % auc_Test_60, color='red')

plt.plot(fpr_Test_315, tpr_Test_315, lw=line_width, label='Test_315 (AUROC = %0.3f)' % auc_Test_315, color='blue')

plt.plot(fpr_Btest_31, tpr_Btest_31, lw=line_width, label='Btest_31 (AUROC = %0.3f)' % auc_Btest_31, color='green')

plt.plot(fpr_UBtest_31, tpr_UBtest_31, lw=line_width, label='UBtest_31 (AUROC = %0.3f)' % auc_UBtest_31, color='orange')
...
# 6.展示图片和保存
plt.savefig('/media/ST-18T/Ma/LGS-PPIS/curve/ROC.jpg', dpi=300)
