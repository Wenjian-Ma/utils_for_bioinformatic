...
# #
# #
# # species_15 = ['9606','7955','3702','8355']
# #
# #
# # for specie in tqdm(species_15):
# #
# #     file1 = pd.read_csv('/media/ST-18T/Ma/HIF2GO/data/CAFA/'+specie+'/backup/'+specie+'.protein.sequences1.v12.0.fasta.tsv',sep='\t',header=None)
# #
# #     file2 = pd.read_csv('/media/ST-18T/Ma/HIF2GO/data/CAFA/'+specie+'/backup/'+specie+'.protein.sequences2.v12.0.fasta.tsv',sep='\t',header=None)
# #
# #     file3 = pd.read_csv('/media/ST-18T/Ma/HIF2GO/data/CAFA/'+specie+'/backup/'+specie+ '.protein.sequences3.v12.0.fasta.tsv',sep='\t', header=None)
# #
# #     file4 = pd.read_csv('/media/ST-18T/Ma/HIF2GO/data/CAFA/' + specie + '/backup/' + specie + '.protein.sequences4.v12.0.fasta.tsv',sep='\t', header=None)
# #
# #     file5 = pd.read_csv('/media/ST-18T/Ma/HIF2GO/data/CAFA/' + specie + '/backup/' + specie + '.protein.sequences5.v12.0.fasta.tsv',sep='\t', header=None)
# #
# #     file = pd.concat([file1, file2,file3,file4,file5], axis=0, ignore_index=True, join='inner')
# #
# #     file.to_csv('/media/ST-18T/Ma/HIF2GO/data/CAFA/'+specie+'/backup/'+specie+'.protein.sequences.v12.0.fasta.tsv',sep='\t')
# #     print()
#
#
...
# for specie in species_15:
#
#     prots = []
#     with open('/media/ST-18T/Ma/HIF2GO/data/CAFA/'+specie+'/'+specie+'_proteins_id.txt') as f:
#         for line in f:
#             prots.append(line.strip())
#
#     interpro_tsv = pd.read_csv('/media/ST-18T/Ma/HIF2GO/data/CAFA/'+specie+'/backup/'+specie+'.protein.sequences.v12.0.fasta.tsv', delimiter='\t',names=list(range(13)))
#     interpro_list = list(set(list(interpro_tsv[:][2])))
#     interpro_dict = {}
#     id = [i[0] for i in list(interpro_tsv.index)]
#     interpro = list(interpro_tsv[:][2])
#
#     for i in range(len(id)):
#         if id[i] not in interpro_dict.keys():
#             interpro_dict[id[i]] = []
#         interpro_dict[id[i]].append(interpro[i])
#         interpro_dict[id[i]] = list(set(interpro_dict[id[i]]))
#
#
#
#
...
#
#
#     # interpro_feat = np.zeros((len(prots),len(interpro_list)))
#     # for idx,i in enumerate(tqdm(prots)):
#     #     if i not in interpro_dict.keys():
#     #         continue
#     #     else:
#     #         for item in interpro_dict[i]:
#     #             interpro_feat[idx,interpro_list.index(item)]=1
#     # np.save('/media/ST-18T/Ma/HIF2GO/data/'+specie+'/backup/interpro_feat.npy',interpro_feat)
#
#
#
